...
var hMB=_mz(z,'image',['class',3,'mode',1,'src',2],[],e,s,gg)
_(cLB,hMB)
var oNB=_n('text')
...
_(lQB,aRB)
_(oPB,lQB)
var tSB=_mz(z,'uni-icon',['bind:__l',10,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(oPB,tSB)
_(fKB,oPB)
_(oJB,fKB)
var eTB=_n('view')
...
var xAC=_n('text')
var oBC=_oz(z,27,e,s,gg)
_(xAC,oBC)
_(o0B,xAC)
var fCC=_n('text')
_rz(z,fCC,'class',28,e,s,gg)
...
var cGC=_mz(z,'image',['class',32,'mode',1,'src',2],[],e,s,gg)
_(oFC,cGC)
var oHC=_n('text')
...
var tKC=_mz(z,'image',['class',37,'src',1],[],e,s,gg)
_(aJC,tKC)
var eLC=_n('text')
...
var xOC=_mz(z,'image',['class',41,'src',1],[],e,s,gg)
_(oNC,xOC)
var oPC=_n('text')
...
var hSC=_mz(z,'image',['class',45,'src',1],[],e,s,gg)
_(cRC,hSC)
var oTC=_n('text')
...
_(oJB,hEC)
var oVC=_n('view')
var lWC=_mz(z,'uni-list',['bind:__l',48,'vueId',1,'vueSlots',2],[],e,s,gg)
var aXC=_mz(z,'uni-list-item',['bind:__l',51,'bind:click',1,'data-event-opts',2,'title',3,'vueId',4],[],e,s,gg)
_(lWC,aXC)
var tYC=_mz(z,'uni-list-item',['bind:__l',56,'bind:click',1,'data-event-opts',2,'title',3,'vueId',4],[],e,s,gg)
_(lWC,tYC)
var eZC=_mz(z,'uni-list-item',['bind:__l',61,'title',1,'vueId',2],[],e,s,gg)
_(lWC,eZC)
_(oVC,lWC)
_(oJB,oVC)
_(r,oJB)
