...
Z([3,'bottom'])
Z([3,'bottom-u'])
Z([3,'display:flex;flex-direction:row;height:10px;'])
Z([3,'bottom-u-m'])
Z([3,'———————— 第三方登录 ————————'])
Z([3,'bottom-d'])
=======
...
var oP=_mz(z,'input',['placeholder',6,'style',1,'type',2],[],e,s,gg)
_(bO,oP)
_(aL,bO)
_(oJ,aL)
var xQ=_n('view')
...
var oV=_mz(z,'input',['placeholder',14,'style',1,'type',2],[],e,s,gg)
_(hU,oV)
_(oR,hU)
_(oJ,oR)
var cW=_n('view')
...
var oPB=_mz(z,'picker',['bindchange',9,'data-event-opts',1,'mode',2],[],e,s,gg)
var lQB=_n('view')
...
var eTB=_mz(z,'picker',['bindchange',14,'data-event-opts',1,'range',2],[],e,s,gg)
var bUB=_n('view')
...
_(tEB,eFB)
var xWB=_n('view')
_rz(z,xWB,'id',18,e,s,gg)
var oXB=_v()
_(xWB,oXB)
var fYB=function(h1B,cZB,o2B,gg){
var o4B=_n('view')
_rz(z,o4B,'class',22,h1B,cZB,gg)
var l5B=_n('view')
_rz(z,l5B,'class',23,h1B,cZB,gg)
var a6B=_n('view')
_rz(z,a6B,'class',24,h1B,cZB,gg)
var t7B=_n('view')
_rz(z,t7B,'class',25,h1B,cZB,gg)
var e8B=_n('view')
_rz(z,e8B,'class',26,h1B,cZB,gg)
_(t7B,e8B)
var b9B=_n('view')
_rz(z,b9B,'class',27,h1B,cZB,gg)
var o0B=_n('view')
_rz(z,o0B,'class',28,h1B,cZB,gg)
var xAC=_oz(z,29,h1B,cZB,gg)
_(o0B,xAC)
_(b9B,o0B)
var oBC=_n('view')
_rz(z,oBC,'class',30,h1B,cZB,gg)
var fCC=_oz(z,31,h1B,cZB,gg)
_(oBC,fCC)
_(b9B,oBC)
_(t7B,b9B)
_(a6B,t7B)
var cDC=_n('view')
_rz(z,cDC,'class',32,h1B,cZB,gg)
var hEC=_oz(z,33,h1B,cZB,gg)
_(cDC,hEC)
_(a6B,cDC)
_(l5B,a6B)
_(o4B,l5B)
var oFC=_n('view')
_rz(z,oFC,'class',34,h1B,cZB,gg)
var cGC=_n('view')
_rz(z,cGC,'class',35,h1B,cZB,gg)
var oHC=_n('view')
_rz(z,oHC,'class',36,h1B,cZB,gg)
var lIC=_oz(z,37,h1B,cZB,gg)
_(oHC,lIC)
_(cGC,oHC)
var aJC=_n('view')
_rz(z,aJC,'class',38,h1B,cZB,gg)
var tKC=_oz(z,39,h1B,cZB,gg)
_(aJC,tKC)
_(cGC,aJC)
_(oFC,cGC)
var eLC=_n('view')
_rz(z,eLC,'class',40,h1B,cZB,gg)
var bMC=_n('view')
_rz(z,bMC,'class',41,h1B,cZB,gg)
var oNC=_oz(z,42,h1B,cZB,gg)
_(bMC,oNC)
_(eLC,bMC)
var xOC=_n('view')
_rz(z,xOC,'class',43,h1B,cZB,gg)
var oPC=_oz(z,44,h1B,cZB,gg)
_(xOC,oPC)
_(eLC,xOC)
_(oFC,eLC)
var fQC=_n('view')
_rz(z,fQC,'class',45,h1B,cZB,gg)
var cRC=_n('view')
_rz(z,cRC,'class',46,h1B,cZB,gg)
var hSC=_oz(z,47,h1B,cZB,gg)
_(cRC,hSC)
_(fQC,cRC)
var oTC=_n('view')
_rz(z,oTC,'class',48,h1B,cZB,gg)
var cUC=_oz(z,49,h1B,cZB,gg)
_(oTC,cUC)
_(fQC,oTC)
_(oFC,fQC)
_(o4B,oFC)
...
oXB.wxXCkey=2
_2z(z,21,fYB,e,s,gg,oXB,'site','__i0__','')
_(tEB,xWB)
_(r,tEB)
return r
}
...
_(b1C,o2C)
_(aXC,b1C)
var x3C=_mz(z,'uni-icon',['bind:__l',6,'color',1,'type',2,'vueId',3],[],e,s,gg)
_(aXC,x3C)
_(lWC,aXC)
_(r,lWC)
return r
...
_(hYD,oZD)
_(cXD,hYD)
var c1D=_mz(z,'uni-icon',['bind:__l',10,'color',1,'size',2,'type',3,'vueId',4],[],e,s,gg)
_(cXD,c1D)
_(bSD,cXD)
_(eRD,bSD)
var o2D=_n('view')
...
var fOE=_mz(z,'image',['class',32,'mode',1,'src',2],[],e,s,gg)
_(oNE,fOE)
var cPE=_n('text')
...
var cSE=_mz(z,'image',['class',37,'src',1],[],e,s,gg)
_(oRE,cSE)
var oTE=_n('text')
...
var tWE=_mz(z,'image',['class',41,'src',1],[],e,s,gg)
_(aVE,tWE)
var eXE=_n('text')
...
var x1E=_mz(z,'image',['class',45,'src',1],[],e,s,gg)
_(oZE,x1E)
var o2E=_n('text')
...
_(eRD,xME)
var c4E=_n('view')
var h5E=_mz(z,'uni-list',['bind:__l',48,'vueId',1,'vueSlots',2],[],e,s,gg)
var o6E=_mz(z,'uni-list-item',['bind:__l',51,'bind:click',1,'data-event-opts',2,'title',3,'vueId',4],[],e,s,gg)
_(h5E,o6E)
var c7E=_mz(z,'uni-list-item',['bind:__l',56,'bind:click',1,'data-event-opts',2,'title',3,'vueId',4],[],e,s,gg)
_(h5E,c7E)
var o8E=_mz(z,'uni-list-item',['bind:__l',61,'title',1,'vueId',2],[],e,s,gg)
_(h5E,o8E)
_(c4E,h5E)
_(eRD,c4E)
_(r,eRD)
